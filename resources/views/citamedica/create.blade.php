...
@section('title', 'Creación de cita médica')
            ...
            <form class="needs-validation" novalidate>
                <div class="row g-3 mb-1">
                    <div class="col-sm-12 mt-2">
                        ...
                        <select class="form-select p-1" id="paciente" aria-label="Default select example" onchange="">
                    ...
                    <div class="col-sm-12 mt-2">
                        ...
                        <select class="form-select p-1" id="especialidad" aria-label="Default select example" onchange="">
