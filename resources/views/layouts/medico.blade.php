...
<head>
    ...
    <style>
        body {
            background-image: linear-gradient(rgba(13,110,253,0),rgba(13,110,253,0)),url({{asset('images/back.png')}});
        }
        body {
                ...
                <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu"
                    ...
                    <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2" href="{{ url('horario') }}">
                                    <svg class="bi">
                            ...
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2" href="{{ url('historia') }}">
                                    <svg class="bi">
